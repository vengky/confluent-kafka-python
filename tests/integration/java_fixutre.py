...
class JavaMessage(object):
    ...
    def __str__(self):
        return "Topic {} Partition {} Offset {} Key {} Value {}".format(self.topic(),
                                                                        self.partition(),
                                                                        self.offset(),
                                                                        self.key(), self.value())
...
class JavaProducer(object):
    ...
    def __init__(self, args, cluster):
        ...
        cmd = [os.path.join(work_dir, 'serialization', 'java', 'run-class.sh'),
               "JavaTestRunner", "producer"]
    ...
    def flush(self, timeout=1.0):
        ...
        _read(self._producer.stdout, timeout)
